...
COPY_COMMIT_LINK = hotkey(Qt.CTRL | Qt.ALT | Qt.Key_L)
COPY_COMMIT_MESSAGE = hotkey(Qt.CTRL | Qt.ALT | Qt.Key_M)
COPY_COMMIT_ONELINE = hotkey(Qt.CTRL | Qt.ALT | Qt.Key_O)
COPY_COMMIT_TITLE = hotkey(Qt.CTRL | Qt.ALT | Qt.Key_T)
...
DAG = hotkey(Qt.ALT | Qt.SHIFT | Qt.Key_D)
...
NAVIGATE_BACK = hotkey(Qt.ALT | Qt.Key_Left)
